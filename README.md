...
| [04_bert_text_classification](04_bert_text_classification/) | BERT 中文酒店评论二分类（Tokenizer / BERT / Fine-tuning / AdamW） | [从零看懂PyTorch_BERT中文酒店评论二分类.md](04_bert_text_classification/从零看懂PyTorch_BERT中文酒店评论二分类.md) |

## 学习资料

- [Python 语法速补](Python语法速补.md) —— 本项目代码用到的所有进阶 Python 语法（类、魔法方法、with、yield 等）
